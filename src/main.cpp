        ...
        if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    vector<double> ptsx = j[1]["ptsx"]; // waypoint x global
                    vector<double> ptsy = j[1]["ptsy"]; // waypoint y global
                    double px = j[1]["x"]; // car pose x global
                    double py = j[1]["y"]; // car pose y global
                    double psi = j[1]["psi"]; // vehicle orientation in rad
                    double v = j[1]["speed"]; // speed along orientation mph
                    ...
                    /*
                     * Convert waypoints into the current car's coordinate frame:
                     * */
                    ...
                    // calcualate cross track error with predicted pose:
